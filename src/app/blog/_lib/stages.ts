...
export const STAGES: Stage[] = [
  {
    ...
    icon: "globe",
    desc: "타겟 독자 검색·경쟁사·플라트 자사 데이터를 수집해 인사이트로 구조화합니다.",
    inputs: ["네이버·구글 트렌드", "경쟁사 블로그 (엔코·미스터멘션)", "플라트 매물·게스트 리뷰"],
    outputs: ["리서치 노트", "인사이트 카드"],
    kpi: "수집 소스",
    kpiValue: "26",
    href: "/blog/research",
  },
  {
    ...
    icon: "sparkles",
    desc: "게스트 여정 7단계(Consider→Change)별로 주제를 30~50개 확장 생성합니다.",
    inputs: ["리서치 노트", "게스트 여정", "페르소나"],
    outputs: ["토픽 후보 30~50", "클러스터"],
    kpi: "아이디어",
    kpiValue: "96",
    href: "/blog/ideation",
  },
  {
    ...
    icon: "target",
    desc: "스코어링 퍼널로 후보를 10→5→3개로 압축합니다. 플라트 매물 매칭도를 가중합니다.",
    inputs: ["검색량·경쟁도", "페르소나 매칭", "플라트 매물 매칭"],
    outputs: ["최종 주제 3건", "브리프"],
    kpi: "최종 선정",
    kpiValue: "3",
    href: "/blog/topics",
  },
  {
    ...
    icon: "pen",
    desc: "브리프 기반으로 초안을 섹션별 생성·편집합니다. 플라트 보이스 가이드 적용.",
    inputs: ["브리프", "톤 가이드", "레퍼런스"],
    outputs: ["초안"],
    kpi: "작성 중",
    kpiValue: "5",
    href: "/blog/write",
